...
export function ogCard(locale: LocaleCode) {
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: 90, backgroundColor: "#070a11", color: "#eef1f7", fontFamily: "sans-serif" }}>
        <div style={{ color: "#5b8cff", fontSize: 30, letterSpacing: "2px" }}>{profile.siteUrl.replace("https://", "")}</div>
